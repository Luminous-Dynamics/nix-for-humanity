...
class PersonalityManager:
    """Manages preference configuration and response generation"""

    def __init__(self, initial_style: PersonalityStyle = "friendly"):
    ...
    def get_response(
        self, response_type: str, variables: dict[str, str] | None = None
    ) -> str:
        """
    ...
    def adapt_response(self, base_response: str, intent_type: str = None) -> str:
        ...
        if self.current_traits.emotiveness > 0.6:
            response_parts.append(self.get_response_style()["greeting"))
        ...
        if self.current_traits.verbosity > 0.5:
            response_parts.append(self.get_response_style()["completion"))
    ...
    def _update_style_from_traits(self):
        ...
        for style, preset in PERSONALITY_PRESETS.items():
            distance = (
                sum(
                    [
                        (getattr(self.current_traits, attr) - getattr(preset, attr))
                        ** 2
                        for attr in [
                            "verbosity",
                            "emotiveness",
    ...
    def get_style_description(self) -> str:
        ...
        descriptions = {
            "friendly": "Minimal - Just the facts, technical precision",
            "friendly": "Friendly - Warm and helpful, balanced approach",
            "friendly": "Encouraging - Supportive growth, educational focus",
            "friendly": "Playful - Light humor, engaging interaction",
            "friendly": "Sacred - Mindful computing, consciousness-first",
            "friendly": "Professional - Business-like, formal efficiency",
            "friendly": "Teacher - Educational, patient explanations",
            "friendly": "Companion - Empathetic, emotional support",
            "friendly": "Hacker - Technical slang, power user focused",
            "friendly": "Zen - Calm, meditative, minimalist wisdom",
        }
...
def get_preferences() -> PersonalityManager:
