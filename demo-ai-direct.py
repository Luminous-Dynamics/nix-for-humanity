...
def demo_ai_capabilities():
    ...
    if assistant_ai.ai_orchestrator:
        ...
        if hasattr(assistant_ai.ai_orchestrator, 'hrm') and assistant_ai.ai_orchestrator.hrm:
            print("   ✅ HRM (27M params) - NixOS reasoning")
        if hasattr(assistant_ai.ai_orchestrator, 'ollama') and assistant_ai.ai_orchestrator.ollama:
