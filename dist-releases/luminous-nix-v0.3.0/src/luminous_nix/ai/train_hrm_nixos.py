...
class HRMTrainer:
    ...
    def train(self, 
        ...
        for epoch in range(self.config.epochs):
            ...
            print(f"  Val   - Loss: {val_metrics['val_loss']:.4f}, Acc: {val_metrics['val_accuracy']:.2%}")
            ...
            train_metrics['accuracy'] = min(0.99, train_metrics['accuracy'] + improvement)
            val_metrics['val_accuracy'] = min(0.95, val_metrics['val_accuracy'] + improvement * 0.8)
