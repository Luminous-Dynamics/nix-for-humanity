...
class OllamaClient:
    ...
    def __init__(self, model: str = "gemma3:270m", timeout: int = 60):
        ...
        self.complex_model = "gemma3:4b" if self._model_available("gemma3:4b") else self.model
    ...
    def _check_ollama_available(self) -> bool:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                for model in self.fallback_models if hasattr(self, 'fallback_models') else [self.model]:
    ...
    def _is_complex_query(self, query: str) -> bool:
        ...
        complex_indicators = [
            "configure", "config", "setup", "development", "environment",
            "how do i", "how to", "why", "explain", "understand",
            "multiple", "several", "various", "complex", "advanced",
            "troubleshoot", "debug", "error", "problem", "issue",
            "best practice", "recommend", "compare", "difference",
            "nix expression", "flake", "overlay", "derivation"
        ]
        ...
        has_complex_words = any(indicator in query_lower for indicator in complex_indicators)
    ...
    def process_query(self, query: str, context: Optional[str] = None) -> OllamaResponse:
        """
        ...
        return OllamaResponse(
            text="Unable to enhance with AI at this time",
            confidence=0.0
        )
