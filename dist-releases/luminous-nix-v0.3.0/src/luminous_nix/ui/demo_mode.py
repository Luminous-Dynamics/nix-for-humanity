...
🎬 Demo Mode for Luminous Nix TUI
...
class DemoScript:
    ...
    def load_showcase_script(self) -> None:
        ...
        self.script = [
            ...
            DemoStep(
                "narrate",
                "🌟 Welcome to Luminous Nix Enhanced TUI Demo",
                3.0,
                "Introduction",
            ),
            DemoStep("wait", "", 1.0),
            ...
            DemoStep(
                "narrate", "✨ Watch the thought particles as we install software", 2.0
            ),
            ...
            DemoStep("wait", "", 3.0),
            DemoStep(
                "narrate", "🌟 Visit github.com/Luminous-Dynamics/luminous-nix", 5.0
            ),
        ]
    ...
    def load_quick_script(self) -> None:
        ...
        self.script = [
            ...
            DemoStep("key", "enter", 0.5),
            DemoStep("wait", "", 3.0),
            DemoStep("narrate", "🌟 Luminous Nix - Making NixOS Accessible", 3.0),
        ]

    async def play(self, on_complete: Callable | None = None) -> None:
    ...
    async def _show_narration(self, text: str, duration: float) -> None:
        ...
        self.app.add_to_history(
            {"type": "system", "message": text, "timestamp": datetime.now()}
        )
    ...
    def export_script(self, filename: str) -> None:
        ...
        with open(filename, "w") as f:
            ...
            for step in self.actions:
                f.write(
                    f"    DemoStep('{step.action}', '{step.content}', "
