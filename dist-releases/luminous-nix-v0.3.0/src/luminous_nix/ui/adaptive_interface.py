...
🎨 configurable interface - Consciousness-First UI Complexity Management
...
class AdaptiveInterface(Container):
    ...
    def compose(self) -> ComposeResult:
        """Compose the configurable interface"""
...
class CommandInput(Widget):
    ...
    def compose(self) -> ComposeResult:
        yield Input(placeholder="✨ Ask me anything...", id="command-input")
