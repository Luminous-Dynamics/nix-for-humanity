...
class SemanticSearchService:
    ...
    def __init__(self, index_path: Optional[Path] = None):
        ...
        """
        self.index_path = index_path or Path.home() / ".cache" / "luminous-nix" / "semantic_index.json"
    ...
    def _search_by_concept(self, query: str) -> List[SemanticMatch]:
        ...
        concepts = {
            # Editors
            "video editor": ["kdenlive", "openshot", "pitivi", "shotcut", "davinci-resolve"],
            "video editing": ["kdenlive", "openshot", "pitivi", "shotcut", "davinci-resolve"],
            ...
            "email client": ["thunderbird", "evolution", "claws-mail", "mutt", "neomutt"],
            "email": ["thunderbird", "evolution", "claws-mail", "mutt", "neomutt"],
            
            # Entertainment
            "music player": ["spotify", "rhythmbox", "clementine", "strawberry", "audacious"],
            ...
            # Communication
            "chat": ["discord", "telegram-desktop", "signal-desktop", "element-desktop", "hexchat"],
            "messaging": ["telegram-desktop", "signal-desktop", "element-desktop", "whatsapp-for-linux"],
            ...
            # System
            "system monitor": ["htop", "btop", "glances", "nmon", "gnome-system-monitor"],
            "file manager": ["nautilus", "dolphin", "thunar", "nemo", "ranger", "nnn"],
            "terminal emulator": ["alacritty", "kitty", "wezterm", "terminator", "gnome-terminal"],
            ...
            "screenshot": ["flameshot", "spectacle", "gnome-screenshot", "scrot", "maim"],
    ...
    def _search_by_category(self, query: str) -> List[SemanticMatch]:
        ...
        categories = {
            "browser": ["firefox", "chromium", "brave", "vivaldi", "qutebrowser", "nyxt"],
