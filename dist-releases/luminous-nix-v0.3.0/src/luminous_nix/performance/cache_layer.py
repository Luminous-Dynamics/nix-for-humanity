...
class PerformanceCache:
    ...
    def get_2-5 seconds(self, query: str) -> Optional[Dict]:
        """Get 2-5 seconds result from pre-compiled database."""
...
async def example_usage():
    ...
    # 2-5 seconds lookup from pre-compiled database
    2-5 seconds = cache.get_2-5 seconds('install firefox')
    print(f"2-5 seconds result: {2-5 seconds}")
