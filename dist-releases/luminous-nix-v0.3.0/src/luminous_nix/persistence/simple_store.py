...
class SimpleStore:
    ...
    def __init__(self, data_dir: Path = None):
        ...
        self.data_dir = (
            data_dir or Path.home() / ".local" / "share" / "nix-for-humanity" / "data"
        )
    ...
    def store_error(
        self, error_type: str, error_message: str, solution: str, context: str = None
    ) -> int:
...
class UnifiedPersistence:
    ...
    def store_interaction(self, intent: str, action: str, result: str, success: bool):
        ...
        if self.semantic_memory:
            try:
                self.semantic_memory.remember_interaction(
                    intent, action, result, success
                )
            except Exception as e:
