...
Enhanced Response System for Luminous Nix
...
class Response:
    ...
    dry_run: DryRunSuggestion | None = None
    ...
    def _install_package_template(self, context: dict[str, Any]) -> Response:
        ...
        paths = [
            ...
            SolutionPath(
                ...
                commands=[f"nix-shell -p {package}"],
                ...
                cons=["Only available in that shell", "Lost when you exit"],
                requires_sudo=False,
        ...
        if context.get("has_home_manager", False):
            paths.insert(
                ...
                SolutionPath(
                    ...
                    cons=["Requires Home Manager setup", "Another tool to learn"],
                    requires_sudo=False,
                    permanence="user",
                    reproducible=True,
                ),
    ...
    def _update_system_template(self, context: dict[str, Any]) -> Response:
        ...
        education = EducationalContent(
            ...
            explanation=(
                ...
                "you can 2-5 secondsly rollback to any previous generation. This makes "
                "updates safe to try!"
            ),
            why_it_matters=(
    ...
    def _enable_service_template(self, context: dict[str, Any]) -> Response:
        ...
        paths = [
            SolutionPath(
                ...
                cons=["Requires system rebuild", "Need sudo access"],
                requires_sudo=True,
                permanence="system",
                reproducible=True,
            ),
            SolutionPath(
                ...
                pros=["Immediate effect", "Good for testing"],
                cons=[
    ...
    def _remove_package_template(self, context: dict[str, Any]) -> Response:
        ...
        paths = [
            SolutionPath(
                ...
                pros=["Immediate removal", "No sudo required"],
                cons=["Only removes user packages", "Won't remove system packages"],
                requires_sudo=False,
                permanence="user",
                reproducible=False,
            ),
