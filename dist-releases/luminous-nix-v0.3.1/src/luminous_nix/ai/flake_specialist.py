...
class FlakeSpecialist:
    ...
    def handle_query(self, query: str) -> Dict:
        ...
        for lang, template_cmd in self.templates.items():
            if lang in query_lower and any(word in query_lower for word in ['new', 'create', 'template', 'project']):
                return {
        ...
        if best_match:
            ...
            elif best_match == 'develop' and any(word in query_lower for word in ['shell', 'env']):
            ...
            return {
                ...
                'category': 'flake',
                'confidence': min(0.95, 0.85 + (best_score / 100)),  # Increased base confidence
                'specialist': 'FlakeSpecialist',
