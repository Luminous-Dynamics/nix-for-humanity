...
class MetaLearningHRM:
    ...
    def learn_new_task_type(self, task_type: str, examples: List[Tuple[str, str]], 
    ...
    def predict_learning_curve(self, task_type: str, n_examples: int) -> List[float]:
        ...
        if task_type in self.task_prototypes:
            ...
            base_rate = 0.5
            learning_rate = proto.feature_weights[0] if len(proto.feature_weights) > 0 else 0.1
        else:
            # Use meta-knowledge
            base_rate = 0.3
            learning_rate = 0.05
    ...
    def optimize_learning_strategy(self, task_type: str, 
                                  constraints: Dict[str, Any]) -> LearningStrategy:
        """
    ...
    def _create_prototype(self, task_type: str, examples: List[Tuple[str, str]]) -> TaskPrototype:
    ...
    def _fast_adapt(self, prototype: TaskPrototype, 
    ...
    def _evaluate(self, model: Dict, examples: List[Tuple[str, str]]) -> Dict[str, float]:
    ...
    def _summarize_strategy(self, prototype: TaskPrototype) -> str:
        ...
        dominant = max(prototype.strategy_distribution.items(), 
...
def demonstrate_meta_learning():
    ...
    result = hrm.learn_new_task_type("container_management", container_examples, n_shot=3)
