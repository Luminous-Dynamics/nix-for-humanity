...
class V1IntegrationTest:
        ...
        for search_term, expected_results in test_searches:
            try:
                ...
                if response.success:
                    ...
                    found_any = any(
                        pkg in response.text.lower() for pkg in expected_results
                    )
                    if found_any:
    ...
    def test_feature_6_home_manager(self):
        ...
        feature_success = (
            handled_count >= 2
        )  # At least 2/3 should be home-manager aware
    ...
    def test_feature_7_flake_support(self):
        ...
        flake_queries = ["update flake", "flake template", "use flakes"]
            ...
            try:
                ...
                if not response.success:
                    ...
                    if any(
                        ...
                        for marker in ["🎓", "Understanding", "Learn"]
                    ):
    ...
    def test_feature_10_settings_profiles(self):
        ...
        for personality in personalities:
            try:
                request = Request(query="help", context={"personality": personality})
                response = self.backend.process(request)
    ...
    def run_all_tests(self):
        ...
        print(
            f"Overall Result: {'✅ READY FOR RELEASE' if self.results['overall_success'] else '❌ NEEDS WORK'}"
        )
