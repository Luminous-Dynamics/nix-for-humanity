...
from src.luminous_nix.ai.update_maintenance_specialist import UpdateMaintenanceSpecialist
...
class TestCoreAccuracy:
    ...
    def setup_method(self):
        ...
        self.test_queries = {
            ...
            'dev': [
                ("python development environment", "nix-shell -p python3 python3Packages.pip"),
