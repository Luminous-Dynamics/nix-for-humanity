...
class EnhancedQueryGenerator:
    ...
    def __init__(self):
        ...
        self.packages = [
            ...
            'vscode', 'vim', 'neovim', 'emacs', 'sublime-text',
            'git', 'gh', 'docker', 'podman', 'kubernetes',
            'python3', 'nodejs', 'rustc', 'go', 'gcc',
            'slack', 'discord', 'telegram-desktop', 'signal-desktop',
            'vlc', 'mpv', 'obs-studio', 'kdenlive',
            'gimp', 'inkscape', 'blender', 'krita',
            'libreoffice', 'thunderbird', 'evolution',
            'steam', 'lutris', 'wine', 'virtualbox',
            'postgresql', 'mysql', 'redis', 'mongodb',
            'nginx', 'apache', 'caddy', 'traefik',
            'htop', 'btop', 'neofetch', 'tree',
            'tmux', 'screen', 'alacritty', 'kitty',
            'zsh', 'fish', 'starship', 'powerline'
        ]
        
        # Services to configure
        self.services = [
            'ssh', 'bluetooth', 'printing', 'scanning',
            'docker', 'virtualbox', 'libvirtd', 'podman',
            'nginx', 'apache', 'mysql', 'postgresql',
            'xserver', 'wayland', 'pipewire', 'pulseaudio',
            'networkmanager', 'firewall', 'fail2ban',
            'syncthing', 'nextcloud', 'samba', 'nfs',
            'cups', 'avahi', 'resolved', 'timesyncd'
        ]
    ...
    def generate_search_queries(self) -> List[Dict]:
        ...
        search_terms = [
            "text editor", "web browser", "terminal emulator",
            "file manager", "image viewer", "video player",
            "music player", "pdf reader", "markdown editor",
            "code editor", "database client", "api testing",
            "screen recorder", "screenshot tool", "color picker",
            "password manager", "note taking", "task manager",
            "system monitor", "disk usage analyzer", "backup tool"
        ]
    ...
    def generate_troubleshooting_queries(self) -> List[Dict]:
        ...
        for error in error_scenarios:
            ...
            queries.append({
                "query": template.format(error=error),
                "category": "error"
            })
