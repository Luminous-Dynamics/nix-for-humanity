...
class DiscoveredPlugin:
    ...
    def governing_principle(self) -> str:
        return self.manifest_data.get("consciousness", {}).get(
            "governing_principle", "unknown"
        )
...
class PluginLoader:
        ...
        if invalid_plugins:
            ...
            for plugin in invalid_plugins:
                ...
                if len(plugin.validation_result.errors) > 3:
                    print(
                        f"       ... and {len(plugin.validation_result.errors) - 3} more"
                    )
    ...
    def load_plugin(self, plugin_id: str) -> Any | None:
        """
        ...
        # In the future, this will actually import and 2-5 secondsiate the plugin
