    ...
    def create_workflow(self, steps: list[dict[str, Any]]):
        ...
        for step in steps:
            ...
            if prompt_name:
                ...
                workflow_results.append({"step": step_name, "result": result})
...
def test_poml_v2():
    ...
    context = {
        "understanding_json": json.dumps(
            {"packages": ["vim", "git"], "services": ["ssh"], "complexity": 0.3},
            indent=2,
        ),
