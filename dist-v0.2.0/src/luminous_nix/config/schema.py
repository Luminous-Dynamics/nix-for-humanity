...
Defines the complete configuration schema for Luminous Nix
...
class CoreConfig:
    ...
    data_directory: str = "~/.local/share/luminous-nix"
    cache_directory: str = "~/.cache/luminous-nix"
...
@dataclass
class ConfigSchema:
    """Complete configuration schema for Luminous Nix"""
