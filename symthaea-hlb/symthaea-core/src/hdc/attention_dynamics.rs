...
impl AttentionDynamics {
    ...
    fn biased_competition(&self) -> Vec<f64> {
        ...
        // Temperature for softmax - higher = sharper winner-take-all
        // With temp=3.0, salience differences are amplified for proper competition
        let temperature = 3.0;
        ...
        for target in &self.targets {
            ...
            competition.push(score * temperature);
        }
