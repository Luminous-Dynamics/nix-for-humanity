...
from monitor_coverage import CoverageMonitor, CRITICAL_PATH_THRESHOLD, CORE_FEATURE_THRESHOLD
...
class TestCoverageMonitor(unittest.TestCase):
    ...
    def test_init(self):
        ...
        # Check database path
        expected_db_path = self.test_project_root / ".coverage_monitor" / "coverage_history.db"
