...
class TestCommandError(unittest.TestCase):
    ...
    def test_command_error_creation(self):
        ...
        error = CommandError(
            ...
            recovery_commands=[
                {"command": "nix search firefox", "description": "Search for firefox"}
            ],
        )
    ...
    def test_command_error_defaults(self):
        ...
        error = CommandError(
            user_message="Something went wrong", suggestions=["Please try again"]
        )
...
class TestEducationalErrorHandler(unittest.TestCase):
    ...
    def test_disk_space_error_pattern(self):
        ...
        disk_errors = ["no space left", "disk full", "insufficient space"]
