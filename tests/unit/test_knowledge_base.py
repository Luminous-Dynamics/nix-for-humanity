...
class TestKnowledgeBase(unittest.TestCase):
    ...
    def test_database_initialization(self):
        ...
        c.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='package_cache'")
        self.assertIsNotNone(c.fetchone())
    ...
    def test_cache_search_results(self):
        ...
        test_results = [
            ...
            {'name': 'firefox-esr', 'version': '115.0', 'description': 'Extended support'}
        ]
    ...
    def test_solutions_have_all_intent_types(self):
        ...
        for intent_type in intent_types:
            ...
            self.assertTrue(
                solution['found'], 
                f"No solution found for intent type: {intent_type}"
            )
