...
from luminous_nix.core.home_manager import DotfileConfig, HomeConfig, ThemeConfig
...
class TestHomeManagerDataclasses(unittest.TestCase):
    ...
    def test_home_config_creation(self):
        ...
        themes = [
            ThemeConfig(name="solarized", type="desktop", settings={"variant": "dark"})
        ]
    ...
    def test_theme_types(self):
        ...
        terminal_theme = ThemeConfig(
            name="nord", type="terminal", settings={"style": "dark"}
        )

        desktop_theme = ThemeConfig(
            name="arc", type="desktop", settings={"window_decorations": "minimal"}
        )

        app_theme = ThemeConfig(
            name="vscode-dark", type="application", settings={"editor.theme": "Dark+"}
        )
    ...
    def test_complex_shell_config(self):
        ...
        shell_config = {
            "shell": "fish",
            "prompt": "starship",
            "aliases": {"ll": "ls -la", "gs": "git status", "gc": "git commit"},
            "environment": {"EDITOR": "nvim", "BROWSER": "firefox"},
            "plugins": ["z", "fzf", "git"],
        }
    ...
    def test_services_configuration(self):
        ...
        services = {
            "gpg-agent": {"enable": True, "defaultCacheTtl": 1800, "maxCacheTtl": 7200},
            "syncthing": {"enable": True, "dataDir": "/home/user/Sync"},
            "redshift": {"enable": True, "temperature": {"day": 5500, "night": 3500}},
        }
