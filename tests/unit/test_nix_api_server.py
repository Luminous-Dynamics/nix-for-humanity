...
class TestAPIServer(unittest.TestCase):
    ...
    def test_health_check(self):
        ...
        # Mock engine stats
        self.engine_mock.get_stats.return_value = {"uptime": "1:23:45", "sessions": 5}
    ...
    def test_process_query_success(self):
        ...
        with patch("api.nix_api_server.request") as request_mock:
            request_mock.get_json.return_value = {
                ...
                "context": {"personality": "friendly", "execution_mode": "dry_run"},
            }
    ...
    def test_process_query_missing_query(self):
        ...
        with patch("api.nix_api_server.request") as request_mock:
            request_mock.get_json.return_value = {"context": {}}
    ...
    def test_process_query_creates_session(self):
        ...
        with patch("api.nix_api_server.request") as request_mock:
            request_mock.get_json.return_value = {"query": "test query"}
    ...
    def test_submit_feedback_no_session_id(self):
        ...
        with patch("api.nix_api_server.request") as request_mock:
            request_mock.get_json.return_value = {"query": "test", "helpful": True}
