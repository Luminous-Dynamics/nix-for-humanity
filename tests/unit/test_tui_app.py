...
class TestNixHumanityApp(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patches = [
            patch('nix_for_humanity.tui.app.NixForHumanityBackend', return_value=self.core_mock),
            patch('nix_for_humanity.tui.app.XAIEngine', return_value=self.xai_engine_mock),
            patch('nix_for_humanity.tui.app.CausalXAI', return_value=self.causal_xai_mock),
            patch('nix_for_humanity.tui.app.ConfidenceCalculator', return_value=self.confidence_calculator_mock),
            patch('nix_for_humanity.tui.app.PersonaExplanationAdapter', return_value=self.explanation_adapter_mock),
            patch('nix_for_humanity.tui.app.PersonaStyleManager', return_value=self.persona_manager_mock),
        ]
    ...
    def test_css_property(self):
        ...
        app = NixHumanityApp()
        self.persona_manager_mock.get_css_styles.return_value = ".custom { color: red; }"
    ...
    def test_process_query_with_xai_enabled(self):
        ...
        self.confidence_calculator_mock.calculate_confidence.return_value = confidence_metrics
    ...
    def test_execute_current_plan_success(self):
        ...
        # Verify execution
        self.core_mock.execute_plan.assert_called_once_with(app.current_plan, "tui-user")
