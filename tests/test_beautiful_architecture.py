...
def test_config_generator():
    ...
    for request in test_requests:
        ...
        if "services" in nix_config and "enable = true" in nix_config:
            print("   ✅ Generated working NixOS configuration!")
        else:
...
def test_plugin_architecture():
    ...
    class TestPlugin(Plugin):
        ...
        def get_commands(self):
            return {"hello": lambda: "Hello from plugin!"}
...
def test_service_composition():
    ...
    from luminous_nix.services import CacheService, ConfigGenerator, SearchService
