...
class MockQuery:
    def __init__(
        self, text="", personality="friendly", mode=None, session_id="", user_id=""
    ):
        self.text = text
...
class TestCLIAdapter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        mock_uuid_obj.__str__ = Mock(
            return_value="abcd1234-5678-9012-3456-789012345678"
        )
    ...
    def test_process_query_explain_mode(self):
        ...
        response = self.adapter.process_query(
            "test query", execute=False, dry_run=False
        )
    ...
    def test_process_query_with_show_intent(self):
        ...
        self.mock_core.intent_engine.recognize.assert_called_once_with(
            "install firefox"
        )
    ...
    def test_display_simple_with_feedback_request(self):
        ...
        mock_response = MockResponse(
            "Response with feedback", [], feedback_requested=True
        )
    ...
    def test_gather_feedback_no_without_comment(self):
        ...
        thank_calls = [
            call for call in mock_print.call_args_list if "Thank you!" in str(call)
        ]
    ...
    def test_get_stats_nested_dict(self):
        ...
        mock_stats = {
            "basic_stats": {"queries": 100, "errors": 2},
            "performance": {"avg_response_time": "1.2s", "cache_hits": "85%"},
    ...
    def test_rich_display_suggestions(self):
        ...
        with patch("builtins.__import__") as mock_import:
            ...
            print_calls = [
                str(call) for call in mock_console_instance.print.call_args_list
            ]
                ...
                with patch("builtins.print") as mock_print:
                    ...
                    if skip_input.lower() == "skip":
                        ...
                        feedback_calls = [
                            call
                            for call in calls
                            if "Thank you" in call or "help better" in call
                        ]
