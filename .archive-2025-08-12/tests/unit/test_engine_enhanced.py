...
from luminous_nix.api.schema import Context, ExecutionResult
from luminous_nix.core.personality import PersonalityStyle
from luminous_nix.api.schema import Response
from luminous_nix.types import dict as dict
from luminous_nix.core.personality import PersonalityStyle
...
class TestEngineEnhanced:
    ...
    def test_plan_remove_intent_requires_confirmation(self):
        ...
        command = Command(
            "nix", ["profile", "remove", "firefox"], True, False, "Remove firefox"
        )
    ...
    def test_plan_update_intent(self):
        ...
        self.mock_knowledge_base.get_solution.return_value = solution
        self.mock_execution_engine.build_command.return_value = command
        self.mock_personality_system.adapt_response.return_value = (
    ...
    def test_plan_search_intent_with_results(self):
        ...
        self.mock_intent_engine.recognize.return_value = intent
        self.mock_knowledge_base.get_solution.return_value = solution
        self.mock_execution_engine.execute_safe_search.return_value = (
            True,
            search_results,
            "",
        )
        self.mock_personality_system.adapt_response.side_effect = (
            lambda x, y, z: x
        )  # Return as-is
    ...
    def test_plan_unknown_intent(self):
        ...
        intent = Intent(
            type=IntentType.UNKNOWN, entities={}, confidence=0.3, raw_input="unknown"
        )
        solution = {
            "found": False,
    ...
    def test_execute_plan_no_command(self):
        ...
        plan = dict(
            ...
            intent=Intent(
                type=IntentType.EXPLAIN, entities={}, confidence=0.9, raw_input="info"
            ),
            command=None,
            suggestions=[],
            confidence=0.9,
    ...
    def test_process_dry_run_mode(self):
        ...
        command = Command(
            "nix", ["profile", "install", "nixpkgs#firefox"], True, False, ""
        )
    ...
    def test_process_execute_mode(self):
        ...
        query = {"query": "install vim", "execute": True, "user_id": "test_user"}
        intent = Intent(
            type=IntentType.INSTALL_PACKAGE,
            entities={"target": "vim", "package": "vim"},
            confidence=0.9,
    ...
    def test_process_execute_mode_failure(self):
        ...
        command = Command(
            "nix", ["profile", "install", "nixpkgs#badpackage"], True, False, ""
        )
    ...
    def test_process_symbiotic_feedback(self):
        ...
        intent = Intent(
            type=IntentType.HELP, entities={}, confidence=0.9, raw_input="help"
        )
    ...
    def test_edge_case_empty_query(self):
        ...
        query = {"query": "".DRY_RUN}
        intent = Intent(
            type=IntentType.UNKNOWN, entities={}, confidence=0.1, raw_input="unknown"
        )
