...
class TestCLIAdapter(unittest.TestCase):
    ...
    def test_init_server_mode_default(self, mock_client_class):
        ...
        mock_client_class.assert_called_once_with(
            socket_path="/tmp/nix-for-humanity.sock"
        )
    ...
    def test_collect_feedback_server_mode(self, mock_client_class):
        ...
        # Verify
        expected_params = {"session_id": "test_session", "feedback": feedback}
    ...
    @patch("adapters.cli_adapter.HeadlessEngine")
    def test_run_interactive_exit_commands(
        self, mock_engine_class, mock_print, mock_input
    ):
    ...
    @patch("builtins.print")
    @patch("adapters.cli_adapter.HeadlessEngine")
    def test_run_interactive_help_command(
        self, mock_engine_class, mock_print, mock_input
    ):
        ...
        help_shown = any(
            "Available commands:" in str(call) for call in mock_print.call_args_list
        )
    ...
    @patch("builtins.print")
    @patch("adapters.cli_adapter.HeadlessEngine")
    def test_run_interactive_stats_command(
        self, mock_engine_class, mock_print, mock_input
    ):
        ...
        stats_shown = any(
            "📊 Stats:" in str(call) for call in mock_print.call_args_list
        )
    ...
    @patch("builtins.print")
    @patch("adapters.cli_adapter.HeadlessEngine")
    def test_run_interactive_query_processing(
        self, mock_engine_class, mock_print, mock_input
    ):
    ...
    @patch("builtins.print")
    @patch("adapters.cli_adapter.HeadlessEngine")
    def test_run_interactive_error_handling(
        self, mock_engine_class, mock_print, mock_input
    ):
        ...
        error_shown = any(
            "❌ Error: Test error" in str(call) for call in mock_print.call_args_list
        )
    ...
    @patch("builtins.print")
    @patch("adapters.cli_adapter.HeadlessEngine")
    def test_collect_feedback_interaction(
        self, mock_engine_class, mock_print, mock_input
    ):
        ...
        self.assertEqual(
            feedback_call[1]["improved_response"], "Should be more detailed"
        )
    ...
    @patch("builtins.print")
    @patch("adapters.cli_adapter.HeadlessEngine")
    def test_collect_feedback_error_handling(
        self, mock_engine_class, mock_print, mock_input
    ):
        ...
        # Verify error was shown
        error_shown = any(
            "⚠️  Feedback error:" in str(call) for call in mock_print.call_args_list
        )
        self.assertTrue(error_shown)
...
class TestCLIAdapterMain(unittest.TestCase):
    ...
    def test_main_with_query(self, mock_print, mock_adapter_class):
        ...
        mock_adapter_class.assert_called_once_with(
            use_server=False, server_address=None
        )
    ...
    @patch(
        "sys.argv",
        ["cli_adapter.py", "--server", "--server-address", "tcp://localhost:8888"],
    )
    @patch("adapters.cli_adapter.CLIAdapter")
    def test_main_server_mode(self, mock_adapter_class):
        ...
        mock_adapter_class.assert_called_once_with(
            use_server=True, server_address="tcp://localhost:8888"
        )
