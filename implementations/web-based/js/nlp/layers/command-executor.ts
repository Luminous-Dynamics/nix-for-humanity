...
export async function executeRollback(
  ...
  const rollbackCommand: NixCommand = {
    command: cmd,
    args,
 ...
 */
function commandNeedsNetwork(command: NixCommand): boolean {
 ...
 */
function commandNeedsFileWrite(command: NixCommand): boolean {
 ...
 */
async function confirmWithUser(command: NixCommand): Promise<boolean> {
