 ...
 */
import { recognizeIntent } from './layers/intent-recognition';
import { buildCommand } from './layers/command-builder';
import { executeCommand } from './layers/command-executor';
/**
 * Parse batch operations from natural language
 */
export function parseBatchOperations(input) {
 ...
 */
export async function executeBatch(batch, options = {}) {
 ...
 */
export function expandBatchPatterns(input) {
