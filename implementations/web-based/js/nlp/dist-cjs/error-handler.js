...
exports.ERROR_PATTERNS = void 0;
exports.handleError = handleError;
exports.formatErrorResponse = formatErrorResponse;
exports.getErrorRecoverySteps = getErrorRecoverySteps;
 ...
 */
function getErrorRecoverySteps(error, originalCommand) {
    const steps = [];
    // Network errors
...
function isRecoverableError(error) {
    const recoverablePatterns = [
        exports.ERROR_PATTERNS.NETWORK,
        exports.ERROR_PATTERNS.PERMISSION,
        exports.ERROR_PATTERNS.DISK_SPACE,
        exports.ERROR_PATTERNS.TIMEOUT
    ];
