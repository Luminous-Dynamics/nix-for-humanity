 ...
 */
export function handleError(error: string, command?: string): UserFriendlyError {
  // Network errors
 ...
 */
export function formatErrorResponse(error: UserFriendlyError): string {
 ...
 */
export function getErrorRecoverySteps(error: UserFriendlyError, originalCommand?: string): string[] {
  const steps: string[] = [];
