...
"""
        ...
        return self.run_poetry_command(api_test.replace("'", "\\'").replace("\n", "; "), "API Functions")
...
"""
        ...
        return self.run_poetry_command(db_test.replace("'", "\\'").replace("\n", "; "), "Database Performance")
...
"""
        ...
        return self.run_poetry_command(features_test.replace("'", "\\'").replace("\n", "; "), "5 Intelligent Features")
...
"""
        ...
        return self.run_poetry_command(perf_test.replace("'", "\\'").replace("\n", "; "), "Performance Targets")
