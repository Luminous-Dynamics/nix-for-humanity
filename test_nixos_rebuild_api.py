...
def setup_python_path() -> bool:
    ...
    try:
        ...
        if site_packages.exists():
            ...
            print(f"❌ Site packages not found at {rebuild_path}/lib/python*/site-packages")
            return False
...
def test_imports():
    ...
    try:
        from nixos_rebuild import models, nix, services, utils, process
...
def test_query_operations():
    ...
    try:
        from nixos_rebuild import nix, models, utils
...
def test_build_dry_run():
    ...
    try:
        ...
        print("  nix.switch_to_configuration(path, models.Action.SWITCH, models.Profile.SYSTEM)")
...
"""
    ...
    # Save documentation
    doc_path = Path("/srv/luminous-dynamics/11-meta-consciousness/luminous-nix/NIXOS_REBUILD_PYTHON_API_DOCS.md")
