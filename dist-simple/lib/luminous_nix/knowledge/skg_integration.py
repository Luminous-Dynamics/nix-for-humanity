...
class SKGIntegration:
    ...
    def __init__(self):
        ...
        self.skg = get_skg()
        self.current_context: InteractionContext | None = None
    ...
    def _initialize_core_entities(self):
        ...
        core_entities = [
            ...
            OntologicalEntity(
                EntityType.CONCEPT, "flakes", "Nix flakes for reproducible builds"
            ),
            OntologicalEntity(
                EntityType.CONCEPT, "home-manager", "User environment management"
            ),
            OntologicalEntity(
                EntityType.CONCEPT, "configuration.nix", "System configuration file"
            ),
        ]
    ...
    def get_recommended_solution(self, problem: str) -> dict[str, Any] | None:
    ...
    def check_ethical_boundary(self, command: str) -> str | None:
    ...
    def get_user_context(self) -> dict[str, Any]:
        ...
        if user_model["preferences"]:
            user_model["personalization"] = self._generate_personalization(
    ...
    def _generate_personalization(self, preferences: dict) -> dict[str, Any]:
        ...
        if "learning" in preferences:
            if (
                preferences["learning"].get("needs_examples", {}).get("confidence", 0)
                > 0.6
            ):
    ...
    def export_knowledge_graph(self) -> dict[str, Any]:
        ...
        with self.skg._get_connection() as conn:
            ...
            export["layers"]["metacognitive"]["average_confidence"] = cursor.fetchone()[
                "avg_confidence"
            ]
...
_integration_instance: SKGIntegration | None = None
