...
class FriendlyErrorHandler:
    ...
    def extract_line_number(self, error_message: str) -> tuple[str, int] | None:
    ...
    def format_for_terminal(
        self, friendly_error: FriendlyError, use_color: bool = True
    ) -> str:
    ...
    def diagnose_configuration_file(
        self, file_path: str = "/etc/nixos/configuration.nix"
    ) -> list[str]:
