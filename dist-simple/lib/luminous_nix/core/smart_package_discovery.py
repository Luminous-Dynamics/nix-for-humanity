...
class SmartPackageDiscovery:
    ...
    def find_packages(
        self, query: str, available_packages: list[dict[str, str]] | None = None
    ) -> list[PackageMatch]:
        """
    ...
    def _fuzzy_match_packages(
        self, query: str, packages: list[dict[str, str]]
    ) -> list[PackageMatch]:
    ...
    def suggest_correction(self, query: str) -> str | None:
        ...
        close_matches = difflib.get_close_matches(
            query_lower, all_known, n=1, cutoff=0.6
        )
        if close_matches:
...
# Global instance
_DISCOVERY: SmartPackageDiscovery | None = None
