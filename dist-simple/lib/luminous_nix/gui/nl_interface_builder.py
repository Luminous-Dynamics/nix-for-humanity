...
class ParsedIntent:
    ...
    target: Optional[str]  # What to show/create/modify
    purpose: Optional[str]  # Why they want it
    ...
    data_context: Optional[str] = None  # What data to work with
...
class NaturalLanguageParser:
    ...
    def parse(self, text: str, context: Optional[UserContext] = None) -> ParsedIntent:
        """Parse natural language into structured intent"""
    ...
    def _extract_interface_type(self, text: str) -> Optional[InterfaceType]:
    ...
    def _extract_modifiers(self, text: str) -> List[str]:
        ...
        modifier_words = [
            'simple', 'complex', 'fast', 'slow', 'easy', 'difficult',
            'large', 'small', 'responsive', 'static', 'dynamic',
            'real-time', 'cached', 'live', 'interactive'
        ]
    ...
    def _extract_data_context(self, text: str) -> Optional[str]:
        """Extract data context if mentioned"""
        data_keywords = [
            'data', 'metrics', 'statistics', 'numbers', 'information',
            'content', 'text', 'images', 'files', 'documents'
        ]
...
class InterfaceComposer:
    ...
    def compose(self, 
                components: List[SynthesizedComponent],
                intent: ParsedIntent,
                context: UserContext) -> InterfaceSpecification:
    ...
    def _select_layout(self, intent: ParsedIntent, context: UserContext) -> Dict[str, Any]:
    ...
    def _dashboard_layout(self, intent: ParsedIntent, context: UserContext) -> Dict[str, Any]:
    ...
    def _form_layout(self, intent: ParsedIntent, context: UserContext) -> Dict[str, Any]:
    ...
    def _list_layout(self, intent: ParsedIntent, context: UserContext) -> Dict[str, Any]:
    ...
    def _editor_layout(self, intent: ParsedIntent, context: UserContext) -> Dict[str, Any]:
    ...
    def _viewer_layout(self, intent: ParsedIntent, context: UserContext) -> Dict[str, Any]:
    ...
    def _monitor_layout(self, intent: ParsedIntent, context: UserContext) -> Dict[str, Any]:
    ...
    def _workspace_layout(self, intent: ParsedIntent, context: UserContext) -> Dict[str, Any]:
    ...
    def _widget_layout(self, intent: ParsedIntent, context: UserContext) -> Dict[str, Any]:
    ...
    def _default_layout(self, intent: ParsedIntent, context: UserContext) -> Dict[str, Any]:
    ...
    def _generate_theme(self, intent: ParsedIntent, context: UserContext) -> Dict[str, Any]:
    ...
    def _define_interactions(self, 
                            intent: ParsedIntent, 
                            components: List[SynthesizedComponent]) -> Dict[str, Any]:
        ...
        if len(components) > 1:
            interactions['navigation'] = {
                'type': 'sequential' if 'form' in str(intent.interface_type) else 'free',
                'keyboard': True,
                'touch': context.device_type in ['mobile', 'tablet'] if hasattr(self, 'context') else False
            }
        ...
        if intent.data_context:
            interactions['dataFlow'] = {
                ...
                'updateStrategy': 'realtime' if 'real-time' in intent.modifiers else 'onDemand'
            }
        
        return interactions
    
    def _create_data_bindings(self,
                            intent: ParsedIntent,
                            components: List[SynthesizedComponent]) -> Dict[str, Any]:
        ...
        for component in components:
            if component.dna.data_bindings.get('sources'):
                bindings[component.id] = {
                    'source': component.dna.data_bindings['sources'][0] if component.dna.data_bindings['sources'] else 'default',
                    'transform': component.dna.data_bindings.get('transformations', []),
                    'updateFrequency': component.dna.data_bindings.get('update_frequency', 1000)
                }
...
class NLInterfaceBuilder:
    ...
    def build_interface(self, 
                        request: str, 
                        context: Optional[UserContext] = None) -> InterfaceSpecification:
        ...
        # Compose interface
        interface = self.composer.compose(components, intent, context or self._default_context())
    ...
    def _generate_requirements(self, 
                              intent: ParsedIntent, 
                              context: Optional[UserContext]) -> List[ComponentRequirements]:
        ...
        if intent.interface_type == InterfaceType.DASHBOARD:
            ...
            requirements_list.extend([
                ComponentRequirements(
                    ...
                    data_type="chart",
                    visual_style=intent.style_preferences[0] if intent.style_preferences else "auto"
                ),
                ComponentRequirements(
