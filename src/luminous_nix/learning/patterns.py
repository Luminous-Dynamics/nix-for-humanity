...
class PatternLearner:
    ...
    def record_pattern(self, input_text: str, command: str, success: bool, 
        ...
        ''', (pattern_key, self._extract_template(input_text),
    ...
    def get_suggestion(self, input_text: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def _generate_pattern_key(self, input_text: str) -> str:
        ...
        action_words = ['install', 'update', 'remove', 'show', 'list', 
                       'start', 'stop', 'restart', 'enable', 'disable',
                       'search', 'find', 'check', 'clean', 'build']
