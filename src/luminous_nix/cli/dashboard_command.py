...
from ..ui.interactive_dashboard import DashboardView, InteractiveDashboard


@click.command(name="dashboard")
@click.option(
    "--view",
    type=click.Choice([v.value for v in DashboardView]),
    default="overview",
...
@click.option(
    ...
    default="all",
    help="Specific metric to monitor",
)
