...
class ImprovedUsageAnalytics:
    ...
    def get_session_analytics(self) -> Dict[str, Any]:
        ...
        analytics = {
            ...
            "queries_per_minute": (self.session_queries / max(1, session_duration)) * 60
        }
...
class SmartCacheOptimizerImproved:
    ...
    def _start_optimizer(self):
        ...
        self.optimization_thread = threading.Thread(target=optimizer_worker, daemon=True)
    ...
    def get_status(self) -> Dict:
        ...
        return {
            ...
            "time_since_last": time.time() - self.last_optimization if self.last_optimization else None
        }
