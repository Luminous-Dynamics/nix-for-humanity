...
class HybridCache:
    ...
    def search_hybrid(self, query: str) -> tuple[list[dict], float, str]:
        ...
        # Start async fetch
        threading.Thread(
            target=self._fetch_and_cache, args=(query,), daemon=True
        ).start()
            ...
            return [
                {
                    "name": "firefox",
                    "version": "latest",
                    "description": "Mozilla Firefox (loading exact version...)",
                },
                {
                    "name": "chromium",
                    "version": "latest",
                    "description": "Open source browser (loading...)",
                },
            ]
            ...
            return [
                {
                    "name": "vim",
                    "version": "latest",
                    "description": "Vi IMproved (loading exact version...)",
                },
                {
                    "name": "neovim",
                    "version": "latest",
                    "description": "Modern Vim (loading...)",
                },
                {
                    "name": "emacs",
                    "version": "latest",
                    "description": "Extensible editor (loading...)",
                },
            ]
            ...
            return [
                {
                    "name": "python3",
                    "version": "3.x",
                    "description": "Python interpreter (loading exact version...)",
                },
                {
                    "name": "python311",
                    "version": "3.11.x",
                    "description": "Python 3.11 (loading...)",
                },
            ]
        else:
    ...
    def _get_system_state(self) -> str:
        ...
        try:
            ...
            result = subprocess.run(
                ["nixos-version", "--json"], capture_output=True, text=True, timeout=1
            )
