...
class POMLValidator:
    ...
    def validate_file(self, poml_file: Path) -> ValidationResult:
        ...
        try:
            ...
            return ValidationResult(is_valid=not has_errors, issues=issues, stats=stats)
            ...
            return ValidationResult(
                ...
                issues=[
                    ValidationIssue(
                        level=ValidationLevel.ERROR, message=f"Validation error: {e}"
                    )
                ],
                stats={},
            )
    ...
    def _validate_style(
        self, root: ET.Element, poml_file: Path
