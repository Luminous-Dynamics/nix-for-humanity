...
def create_test_training_data():
    ...
    training_data = {
        "queries": [
            ...
            {
                "query": "install chrome browser",
                "category": "install",
                "command": "nix-env -iA nixpkgs.google-chrome",
            },
            {
                "query": "install vscode",
                "category": "install",
                "command": "nix-env -iA nixpkgs.vscode",
            },
            {
                "query": "install vim editor",
                "category": "install",
                "command": "nix-env -iA nixpkgs.vim",
            },
            {
                "query": "get spotify music player",
                "category": "install",
                "command": "nix-env -iA nixpkgs.spotify",
            },
            ...
            {
                "query": "setup rust development",
                "category": "dev",
                "command": "nix-shell -p rustc cargo",
            },
            {
                "query": "create node.js environment",
                "category": "dev",
                "command": "nix-shell -p nodejs",
            },
            {
                "query": "java development setup",
                "category": "dev",
                "command": "nix-shell -p jdk maven",
            },
            {
                "query": "go programming environment",
                "category": "dev",
                "command": "nix-shell -p go",
            },
            # Update operations
            {
                "query": "update system",
            ...
            # Search operations
            {
                "query": "search text editors",
                "category": "search",
                "command": "nix search nixpkgs editor",
            },
            {
                "query": "find pdf viewers",
                "category": "search",
                "command": "nix search nixpkgs pdf",
            },
            {
                "query": "list available browsers",
                "category": "search",
                "command": "nix search nixpkgs browser",
            },
            # Configuration
            {
                "query": "edit system configuration",
                "category": "config",
...
def test_real_model_performance():
    ...
    print(
        f"  Model Parameters: {sum(p.numel() for p in processor.model.parameters()):,}"
    )
