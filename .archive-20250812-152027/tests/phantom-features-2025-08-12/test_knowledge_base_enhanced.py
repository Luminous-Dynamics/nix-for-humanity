...
class TestKnowledgeBaseEnhanced(unittest.TestCase):
    ...
    def test_get_solution_with_context(self):
        ...
        solution = self.kb.get_solution(
            IntentType.INSTALL_PACKAGE, {"package": "firefox"}
        )
        self.assertIsNotNone(solution)
        self.assertIn("install_package", solution.lower())
    ...
    def _seed_solution_data(self):
        ...
        solutions = [
            ...
            (
                ...
                "update",
                "system",
                "To update NixOS:\n- Update channel: nix-channel --update\n- Rebuild: sudo nixos-rebuild switch\n- Or use: sudo nixos-rebuild switch --upgrade",
            ...
            (
                ...
                "search",
                "package",
                "To search for packages:\n- nix search nixpkgs keyword\n- Visit search.nixos.org\n- Use tab completion with nix-env",
                "nix search firefox",
    ...
    def _seed_problem_data(self):
        ...
        problems = [
            (
                ...
                "disk space",
                "out of space",
                "Run `nix-collect-garbage -d` to free disk space by removing old generations",
            ...
            (
                ...
                "broken",
                "broken package",
                "Try `sudo nixos-rebuild switch --rollback` to return to previous working configuration",
                "Test in nix-shell first",
            ),
            (
                None,
                "conflict",
                "collision",
                "Package conflicts can be resolved by using overlays or removing one of the conflicting packages",
                "Use overlays for conflicts",
            ),
            (
                None,
                "not found",
                "attribute missing",
                "Package might not exist or need different attribute path. Try searching: `nix search nixpkgs package-name`",
