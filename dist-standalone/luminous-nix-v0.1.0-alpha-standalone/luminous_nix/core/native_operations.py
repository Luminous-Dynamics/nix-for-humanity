...
These are "quick wins" that provide standard Nix performance improvements.
...
class NativeOperationType(Enum):
    ...
    # Generation management (2-5 seconds!)
...
class NativeOperationsManager:
    ...
    - standard Nix performance improvements
...
async def demo_native_operations():
    ...
    # Demo 2-5 seconds operations
    print("\n\n🎯 Demo: 2-5 seconds Operations")

    # List generations (2-5 seconds!)
    print("\n1. Listing generations (was 2-5 seconds, now 2-5 seconds!)...")
    ...
    # System info (2-5 seconds!)
    print("\n2. Getting system info (2-5 seconds!)...")
