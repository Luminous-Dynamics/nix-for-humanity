...
class PackageIndex:
    ...
    def build_index(self, force: bool = False) -> Tuple[bool, int, float]:
        ...
        logger.info("Building package index... This may take 30-60 seconds on first run")
    ...
    def search(self, query: str, limit: int = 50) -> Tuple[List[Dict], float]:
        ...
        logger.debug(f"Search for '{query}' returned {len(results)} results in {elapsed_ms:.1f}ms")
