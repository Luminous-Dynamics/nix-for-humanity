...
class EnhancedCache:
    ...
    WARM_QUERIES = [
        # Categories
        "browser", "editor", "terminal", "shell", "development",
        "media", "video", "audio", "graphics", "network",
        "security", "system", "database", "compiler", "language",
        
        # Popular packages
        "firefox", "chromium", "vim", "neovim", "emacs", "vscode",
        "git", "docker", "python", "nodejs", "rust", "go",
        "gcc", "clang", "make", "cmake", "nginx", "apache",
        "postgresql", "mysql", "redis", "mongodb", "sqlite",
        "ffmpeg", "vlc", "mpv", "gimp", "inkscape", "blender",
        "tmux", "screen", "htop", "btop", "neofetch", "tree",
        "curl", "wget", "rsync", "ssh", "gpg", "openssl",
        
        # Common typos
        "fierrfox", "chormium", "pytohn", "dcoker", "postgress"
    ]
    ...
    COMMON_PACKAGES = {
        ...
        "chromium": {"desc": "Open-source Chrome", "cat": "browser", "aliases": ["chrome"]},
        "brave": {"desc": "Privacy browser", "cat": "browser", "aliases": []},
        "vivaldi": {"desc": "Feature-rich browser", "cat": "browser", "aliases": []},
        "qutebrowser": {"desc": "Keyboard-driven browser", "cat": "browser", "aliases": []},
        ...
        # Databases
        "postgresql": {"desc": "SQL database", "cat": "database", "aliases": ["postgres"]},
        ...
        "obs-studio": {"desc": "Recording/streaming", "cat": "media", "aliases": ["obs"]},
    ...
    def __init__(self, cache_dir: Optional[Path] = None, shared_dir: Optional[Path] = None):
    ...
    def fuzzy_search(self, query: str, limit: int = 30) -> Tuple[List[Dict], float, str]:
        """
    ...
    def get_cache_info(self) -> Dict:
        ...
        if self.stats["total_searches"] > 0:
            info["hit_rate"] = self.stats["cache_hits"] / self.stats["total_searches"] * 100
            info["fuzzy_rate"] = self.stats["fuzzy_matches"] / self.stats["total_searches"] * 100
