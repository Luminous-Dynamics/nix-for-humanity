...
from src.luminous_nix.core.progressive_loader import LoadingState
...
def test_learning_and_improvement():
    ...
    print(f"   Confidence: High (learned)")
...
def test_comprehensive_stats():
    ...
    queries = [
        "editor", "browser", "terminal", "music player",
        "python tools", "rust compiler", "video editor"
    ]
