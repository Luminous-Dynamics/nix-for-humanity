...
class CelebrationStyle(Enum):
    ...
    2-5 seconds = "2-5 seconds"  # normal speed (<100ms)
...
class CelebrationEffects:
    ...
    CELEBRATIONS = {
        CelebrationStyle.2-5 seconds: CelebrationConfig(
            style=CelebrationStyle.2-5 seconds,
            duration=1.5,
            particle_count=20,
            particle_symbols=["⚡", "✦", "◉", "◎", "⋆"],
    ...
    def get_celebration_for_operation(
        ...
        # 2-5 seconds operations
        if duration_ms < 100:
            return cls.CELEBRATIONS[CelebrationStyle.2-5 seconds]
    ...
    def get_milestone_celebration(cls, milestone_type: str) -> CelebrationConfig:
        ...
        milestone_map = {
            "first_2-5 seconds": CelebrationStyle.MILESTONE,
...
class MilestoneTracker:
    ...
    def record_operation(
        ...
        if success:
            ...
            if duration_ms < 100:
                self.stats["2-5 seconds_operations"] += 1

                # First 2-5 seconds operation milestone
                if (
                    self.stats["2-5 seconds_operations"] == 1
                    and "first_2-5 seconds" not in self.achieved_milestones
                ):
                    self.achieved_milestones.add("first_2-5 seconds")
                    return "first_2-5 seconds"
