...
def get_extended_profiles() -> Dict[SystemMode, ModeProfile]:
    ...
    return {
        ...
        "developer": ModeProfile(
            ...
            disable_services=["gaming", "streaming", "bluetooth-audio"],
            ...
            nice_adjustments={"compiler": -5, "language-server": -3, "docker": -2},
        ...
        "creative": ModeProfile(
            ...
            disable_services=["development", "databases", "virtualization"],
            ...
            nice_adjustments={"renderer": -10, "preview": -5},
        ...
        "server": ModeProfile(
            ...
            kill_apps=["gui-apps"],
            nice_adjustments={"web-server": -5, "database": -5},
        ...
        "recording": ModeProfile(
            ...
            auto_start_apps=["obs", "audio-mixer", "script-prompter", "camera-app"],
            kill_apps=["everything-else"],
            nice_adjustments={"obs": -10, "encoder": -10},
            suspend_timeout=None,
            screen_timeout=None,
            lock_screen=False,
            vpn_required=False,
...
class ExtendedModeManager(SystemModeManager):
    ...
    def create_custom_blend(
        self, modes: List[str], weights: Optional[List[float]] = None
    ) -> ModeProfile:
