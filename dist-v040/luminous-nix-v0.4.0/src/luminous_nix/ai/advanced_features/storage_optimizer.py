...
class StorageOptimizer:
    ...
    def find_large_packages(self, min_size_mb: float = 100) -> List[Dict]:
        ...
        try:
            ...
            if store_path.exists():
                ...
                examples = [
                    {'name': 'chromium-120.0', 'size_mb': 450, 'path': '/nix/store/xxx-chromium'},
                    {'name': 'libreoffice-7.6', 'size_mb': 380, 'path': '/nix/store/yyy-libreoffice'},
                    {'name': 'texlive-full', 'size_mb': 2800, 'path': '/nix/store/zzz-texlive'},
                ]
    ...
    def _analyze_old_generations(self) -> List[Dict]:
        ...
        try:
            ...
            keep_count = 0
            cutoff_date = datetime.now() - timedelta(days=self.config['min_generation_age_days'])
    ...
    def _generate_cleanup_commands(self, old_gens, orphaned, artifacts, duplicates, aggressive):
        """Generate cleanup commands"""
        commands = []
